...
<html>
	...
	<body>
		<div class="container">
			...
			<br>
			<div id="forms">
				<h5>Excluir - Agendamento de Potenciais Clientes</h5><br>
				...
				<br><br>
				Telefone:<br>
				<input name="txtTelefone" id="txtTelefone" type="tel" size="19" placeholder="(xx)xxxxx-xxxx">
				<br><br>
				Origem:<br>
				...
				<button type="submit" id="btnEditar">Excluir</button>
			</div>
			<br><br><br>
        </div>
    </body>
